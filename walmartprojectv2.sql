...
ORDER BY count(*) desc;
            ...
            --1. Ewallet with 345 orders payments
            --2. Cash with 344 orders payments
            --3. Credit card with 311 order payments
...
-- =========== Create stored procudure to retrieve specific year data========
        --  Workshift column included in the case statment --   
-- -------------------------------------------------------------------------------
delimiter //
